...
You can also paste markdown from other tools. Block-level markdown – headings, lists, blockquotes, code blocks, and tables – automatically renders as formatted content.
...
- Type a markdown table directly and it will be converted to a table on save
